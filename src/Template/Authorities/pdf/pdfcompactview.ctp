...
<table>
    ...
    <?php $nummm = $nummm + 1 ?>    
		  <tr>  
			  ...
			  <b><a href="../../documents/view/<?php echo $documents->id ?>"><?= $nummm ?> / <?php echo $pdocuments->count()?></a></b> &emsp;&emsp;
			  <?php elseif(strlen($nummm)==2):?>
			  <b><a href="../../documents/view/<?php echo $documents->id ?>"><?= $nummm ?> / <?php echo $pdocuments->count()?></a></b>&emsp;&emsp;
			  <?php elseif(strlen($nummm)==3):?>
			  <b><a href="../../documents/view/<?php echo $documents->id ?>"><?= $nummm ?> / <?php echo $pdocuments->count()?></a></b> &emsp;
