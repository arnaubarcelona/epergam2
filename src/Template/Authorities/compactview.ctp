...
<table class="responsive-table">
    ...
    <?php $nummm = $nummm + 1 ?>    
		  <tr>  
			  ...
			  <b><a href="http://127.0.0.1/epergam2/documents/view/<?php echo $documents->id ?>"><?= $nummm ?> / <?php echo count($pdocuments)?></a></b> &emsp;&emsp;
			  <?php elseif(strlen($nummm)==2):?>
			  <b><a href="http://127.0.0.1/epergam2/documents/view/<?php echo $documents->id ?>"><?= $nummm ?> / <?php echo count($pdocuments)?></a></b>&emsp;&emsp;
			  <?php elseif(strlen($nummm)==3):?>
			  <b><a href="http://127.0.0.1/epergam2/documents/view/<?php echo $documents->id ?>"><?= $nummm ?> / <?php echo count($pdocuments)?></a></b> &emsp;
