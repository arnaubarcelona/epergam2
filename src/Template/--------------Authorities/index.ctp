...
<div class="authorities index large-12 medium-8 columns content">
    <br>
    <h3><?= __('Authorities') ?>&emsp;<a href="http://80.211.14.98/epergam2/authorities/pdfindex/1.pdf"><img width="24" height="24" src="http://80.211.14.98/epergam2/webroot/img/icons/printer.png"> </b></a></h3>
    <div class="paginator">
    ...
    <table class="responsive-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2"><a href="http://80.211.14.98/epergam2/authors/view/<?php echo $authority->author_id?>"><?= $authority->author_name ?></a></td>
                <?php if($authority->author_type_id = 1):?>
                <td colspan="2"><center><a href="http://80.211.14.98/epergam2/author_types/view/<?php echo $authority->author_type_id?>">[autoria]</a></td>
                <?php else: ?>
                <td colspan="2"><center><a href="http://80.211.14.98/epergam2/author_types/view/<?php echo $authority->author_type_id?>"><?= $authority->author_type_name ?></a></td>
                <?php endif;?>
                ...
                <td colspan="2" class="actions"><center>
                    <a href="http://80.211.14.98/epergam2/authorities/view/<?=$authority->id?>"><img width="24px" height="24px" src="http://80.211.14.98/epergam2/webroot/img/icons/view.png"></a>
					<a href="http://80.211.14.98/epergam2/authorities/edit/<?=$authority->id?>"><img width="24px" height="24px" src="http://80.211.14.98/epergam2/webroot/img/icons/edit.png"></a>
                    <?= $this->Form->postLink($this->Html->image('http://80.211.14.98/epergam2/webroot/img/icons/delete.png', ['height' => 24, 'width' => 24]), ['action' => 'delete', $authority->id], ['escape' => false, 'confirm' => __('Segur que voleu esborrar ' . $authority->name . '?', $authority->id)]) ?>
                </td>                
            </tr>
            <?php endif; ?>
            <?php endforeach; ?>
