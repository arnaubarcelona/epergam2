...
<div class="noudiv">
	...
	<div class="paginator">
        ...
        <?php $numpages = $this->Paginator->counter(['format' => '{{pages}}']) ?>
		<?php $num1 = $this->Paginator->counter(['format' => '{{start}}'])?>
		<?php $num2 = str_replace('.','',$num1)?>
		<?php $nummm = $num2 - 1?>
