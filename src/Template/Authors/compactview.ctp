...
<div class="noudiv">
    <h3><?= h($author->name) ?></h3>
        ...
        <tr>
		    <td><center><?= $author->id ?></td>            
            <td><center><?= h($author->created->i18nFormat('d/M/YYYY HH:mm')) ?></td>            
            <td><center><?= h($author->modified->i18nFormat('d/M/YYYY HH:mm')) ?></td>
        </tr>
    </table>	
<div class="paginator">
		<table class="responsive-table">
		...
		<a href="http://80.211.14.98/epergam2/authors/pdfcompactview/<?php echo $author->id?>.pdf"><img width="24" height="24" src="http://80.211.14.98/epergam2/webroot/img/icons/printer.png"> </b></a><a href="http://80.211.14.98/epergam2/authors/view/<?php echo $author->id?>"><b>Llista detallada</b></a> | <b>Ordena per:</b> <?= $this->Paginator->sort('name', 'Títol') ?> | <?= $this->Paginator->sort('format_id', 'Format') ?> | <?= $this->Paginator->sort('cdu_id', 'CDU') ?> | <?= $this->Paginator->sort('location_id', 'Ubicació') ?> | <?= $this->Paginator->sort('lending_state_id', 'Préstec') ?> | <?= $this->Paginator->sort('id') ?> | <?= $this->Paginator->sort('created', 'Data de registre') ?>
		</td>
...
<table class="responsive-table">
	...
	<div class="paginator">
		...
		<tr>
		<td colspan="2"  style="height: 42px">
		<a href="http://80.211.14.98/epergam2/authors/compactview/<?php echo $author->id?>.pdf"><img width="24" height="24" src="http://80.211.14.98/epergam2/webroot/img/icons/printer.png"> </b></a><a href="http://80.211.14.98/epergam2/authors/view/<?php echo $author->id?>"><b>Llista detallada</b></a> | <b>Ordena per:</b> <?= $this->Paginator->sort('name', 'Títol') ?> | <?= $this->Paginator->sort('format_id', 'Format') ?> | <?= $this->Paginator->sort('cdu_id', 'CDU') ?> | <?= $this->Paginator->sort('location_id', 'Ubicació') ?> | <?= $this->Paginator->sort('lending_state_id', 'Préstec') ?> | <?= $this->Paginator->sort('id') ?> | <?= $this->Paginator->sort('created', 'Data de registre') ?>
		</td>
		<?php $numpages = $this->Paginator->counter(['format' => '{{pages}}']) ?>
		<td colspan="2">
		<?php if($numpages == "1"):?>
