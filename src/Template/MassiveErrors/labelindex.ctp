...
?>
<div class="noudiv">
    <h3>Errors del generador d'etiquetes</h3>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('created', ['label' => 'Data i hora que s\'ha provat de generar l\'etiqueta']) ?></th>
            </tr>
        </thead>
        <tbody>
    ...
    <?php endif;?>
    <br><br><br>
    <?= $this->Form->postButton('Generar PDF', ['controller' => 'Labels', 'action' => 'pdfindex', '1.pdf']) ?>
</div>
